const copy = {
  en: {
    ...
    feat_2_d: "HD, SD, or audio. TikTok prefers the clean file when the platform gives one.",
    feat_3_t: "It lands in Gallery",
    feat_3_d: "Movies / Nazzil. Play it, share it to WhatsApp or Telegram, done.",
  ...
  ar: {
    ...
    feat_2_d: "HD أو SD أو صوت. تيك توك ياخذ الملف النظيف إذا توفر.",
    feat_3_t: "ينزل بالمعرض",
    feat_3_d: "Movies / Nazzil. شغّله أو شاركه على واتساب وتيليغرام.",
